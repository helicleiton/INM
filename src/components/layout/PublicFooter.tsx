    ...
    <footer className="hero-gradient text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-lg bg-primary-foreground/20 flex items-center justify-center">
                <span className="font-serif text-lg font-bold">IN</span>
              </div>
              <span className="font-serif text-lg">Instituto Novo Milênio</span>
            </div>
            <p className="text-primary-foreground/80 text-sm leading-relaxed mb-4">
              Transformando vidas por meio da educação, cultura e ação social. Construindo um futuro mais justo e humano para todos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={item.path}>
                  <Link to={item.path} className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-12 pt-6 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/60">
          © {new Date().getFullYear()} Instituto Novo Milênio. Todos os direitos reservados.
        </div>
      </div>
