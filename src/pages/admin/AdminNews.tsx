  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-serif text-2xl text-foreground">Notícias</h1>
        <Button size="sm"><Plus className="w-4 h-4 mr-1" /> Nova Notícia</Button>
      </div>
              ...
              <tbody>
                {news.map((n) => (
                  <tr key={n.id} className="border-b border-border last:border-0 hover:bg-muted/50">
                    ...
                    <td className="p-4 text-muted-foreground hidden md:table-cell">{new Date(n.date).toLocaleDateString("pt-BR")}</td>
                    <td className="p-4">
